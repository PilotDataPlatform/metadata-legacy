...
class TestWorkbench(unittest.TestCase):
    ...
    def test_01_create_manifest(self):
        self.log.info("\n")
        self.log.info('01'+f'test create manifest'.center(80, '-'))
        data = {
    ...
    def test_02_get_manifest(self):
        self.log.info("\n")
        self.log.info('02'+f'test get manifest'.center(80, '-'))
    ...
    def test_03_update_manifest(self):
        self.log.info("\n")
        self.log.info('03'+f'test update manifest'.center(80, '-'))
    ...
    def test_04_import_export_manifest(self):
        self.log.info("\n")
        self.log.info('04'+f'test import export manifest'.center(80, '-'))
        manifest_id = self.manifests[0]["id"]
        # Export
        payload = {
    ...
    def test_05_delete_manifest(self):
        self.log.info("\n")
        self.log.info('05'+f'test delete manifest'.center(80, '-'))
    ...
    def test_06_manifest_query(self):
        self.log.info("\n")
        self.log.info('06'+f'test query manifest'.center(80, '-'))
    ...
    def test_07_manifest_list_missing_project_code(self):
        self.log.info("\n")
        self.log.info('07'+f'test list manifest without project code'.center(80, '-'))
    ...
    def test_08_create_manifest(self):
        self.log.info("\n")
        self.log.info('08'+f'test create manifest with error'.center(80, '-'))
    ...
    def test_09_get_manifset_404(self):
        self.log.info("\n")
        self.log.info('09'+f'test get manifest 404'.center(80, '-'))
    ...
    def test_10_update_manifest_404(self):
        self.log.info("\n")
        self.log.info('10'+f'test update manifest with error'.center(80, '-'))
    ...
    def test_11_delete_manifest_404(self):
        self.log.info("\n")
        self.log.info('11'+f'test delete manifest with error'.center(80, '-'))
    ...
    def test_12_import_manifest_attributes(self):
        self.log.info("\n")
        self.log.info('12'+f'test import manifest attributes'.center(80, '-'))
    ...
    def test_13_import_dup(self):
        self.log.info("\n")
        self.log.info('13'+f'test import duplicate manifest'.center(80, '-'))
    ...
    def test_14_import_dup(self):
        self.log.info("\n")
        self.log.info('14'+f'test import duplicate attribute'.center(80, '-'))
